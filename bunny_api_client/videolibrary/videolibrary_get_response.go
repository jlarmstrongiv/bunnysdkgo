...
type VideolibraryGetResponse struct {
    ...
    hasMoreItems *bool
    // The Items property
    items []ie59f1fc195391a433ed92a6780c54480efff53cfc74cc731d5a61ccfbf9645d9.VideoLibraryable
...
func (m *VideolibraryGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["Items"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(ie59f1fc195391a433ed92a6780c54480efff53cfc74cc731d5a61ccfbf9645d9.CreateVideoLibraryFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]ie59f1fc195391a433ed92a6780c54480efff53cfc74cc731d5a61ccfbf9645d9.VideoLibraryable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(ie59f1fc195391a433ed92a6780c54480efff53cfc74cc731d5a61ccfbf9645d9.VideoLibraryable)
                }
            }
            m.SetItems(res)
        }
...
func (m *VideolibraryGetResponse) GetItems()([]ie59f1fc195391a433ed92a6780c54480efff53cfc74cc731d5a61ccfbf9645d9.VideoLibraryable) {
    return m.items
}
...
func (m *VideolibraryGetResponse) SetItems(value []ie59f1fc195391a433ed92a6780c54480efff53cfc74cc731d5a61ccfbf9645d9.VideoLibraryable)() {
    m.items = value
}
...
type VideolibraryGetResponseable interface {
    ...
    GetItems()([]ie59f1fc195391a433ed92a6780c54480efff53cfc74cc731d5a61ccfbf9645d9.VideoLibraryable)
    GetTotalItems()(*int32)
    SetCurrentPage(value *int32)()
    SetHasMoreItems(value *bool)()
    SetItems(value []ie59f1fc195391a433ed92a6780c54480efff53cfc74cc731d5a61ccfbf9645d9.VideoLibraryable)()
