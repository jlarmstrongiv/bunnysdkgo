...
type ScriptItemReleasesGetResponse struct {
    ...
    hasMoreItems *bool
    // The Items property
    items []ia3e53788908e7269a4f8084b0fcc3c88f921087c8f03fe97697eff66be83bcfa.ScriptReleaseable
...
func (m *ScriptItemReleasesGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["Items"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(ia3e53788908e7269a4f8084b0fcc3c88f921087c8f03fe97697eff66be83bcfa.CreateScriptReleaseFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]ia3e53788908e7269a4f8084b0fcc3c88f921087c8f03fe97697eff66be83bcfa.ScriptReleaseable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(ia3e53788908e7269a4f8084b0fcc3c88f921087c8f03fe97697eff66be83bcfa.ScriptReleaseable)
                }
            }
            m.SetItems(res)
        }
...
func (m *ScriptItemReleasesGetResponse) GetItems()([]ia3e53788908e7269a4f8084b0fcc3c88f921087c8f03fe97697eff66be83bcfa.ScriptReleaseable) {
    return m.items
}
...
func (m *ScriptItemReleasesGetResponse) SetItems(value []ia3e53788908e7269a4f8084b0fcc3c88f921087c8f03fe97697eff66be83bcfa.ScriptReleaseable)() {
    m.items = value
}
...
type ScriptItemReleasesGetResponseable interface {
    ...
    GetItems()([]ia3e53788908e7269a4f8084b0fcc3c88f921087c8f03fe97697eff66be83bcfa.ScriptReleaseable)
    GetTotalItems()(*int32)
    SetCurrentPage(value *int32)()
    SetHasMoreItems(value *bool)()
    SetItems(value []ia3e53788908e7269a4f8084b0fcc3c88f921087c8f03fe97697eff66be83bcfa.ScriptReleaseable)()
