...
func NewCheckavailabilityRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*CheckavailabilityRequestBuilder) {
    m := &CheckavailabilityRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/pullzone/checkavailability", pathParameters),
    }
    return m
}
...
// Post [CheckThePullZoneAvailability API Docs](https://docs.bunny.net/reference/pullzonepublic_checkavailability)
...
// ToPostRequestInformation [CheckThePullZoneAvailability API Docs](https://docs.bunny.net/reference/pullzonepublic_checkavailability)
