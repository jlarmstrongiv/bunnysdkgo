...
// ItemRemoveblockedreferrerRemoveBlockedReferrerRequestBuilder builds and executes requests for operations under \pullzone\{-id}\removeBlockedReferrer
...
func NewItemRemoveblockedreferrerRemoveBlockedReferrerRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRemoveblockedreferrerRemoveBlockedReferrerRequestBuilder) {
    m := &ItemRemoveblockedreferrerRemoveBlockedReferrerRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/pullzone/{%2Did}/removeBlockedReferrer", pathParameters),
    }
    return m
}
...
// ToPostRequestInformation [RemoveBlockedReferer API Docs](https://docs.bunny.net/reference/pullzonepublic_removeblockedreferrer)
