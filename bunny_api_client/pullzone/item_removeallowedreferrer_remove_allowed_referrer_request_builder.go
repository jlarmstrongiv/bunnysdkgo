...
// ItemRemoveallowedreferrerRemoveAllowedReferrerRequestBuilder builds and executes requests for operations under \pullzone\{-id}\removeAllowedReferrer
...
func NewItemRemoveallowedreferrerRemoveAllowedReferrerRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRemoveallowedreferrerRemoveAllowedReferrerRequestBuilder) {
    m := &ItemRemoveallowedreferrerRemoveAllowedReferrerRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/pullzone/{%2Did}/removeAllowedReferrer", pathParameters),
    }
    return m
}
...
// ToPostRequestInformation [RemoveAllowedReferer API Docs](https://docs.bunny.net/reference/pullzonepublic_removeallowedreferrer)
