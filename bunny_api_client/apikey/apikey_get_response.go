...
import (
    ...
    i0205054f2bfd71b4890a214c70cc5f227fed51bb9ddda714e68a920d302ce981 "github.com/jlarmstrongiv/bunnysdkgo/bunny_api_client/models/apikeys/listapikeys"
)
...
type ApikeyGetResponse struct {
    ...
    hasMoreItems *bool
    // The Items property
    items []i0205054f2bfd71b4890a214c70cc5f227fed51bb9ddda714e68a920d302ce981.ApiKeyable
...
func (m *ApikeyGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["Items"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i0205054f2bfd71b4890a214c70cc5f227fed51bb9ddda714e68a920d302ce981.CreateApiKeyFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i0205054f2bfd71b4890a214c70cc5f227fed51bb9ddda714e68a920d302ce981.ApiKeyable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(i0205054f2bfd71b4890a214c70cc5f227fed51bb9ddda714e68a920d302ce981.ApiKeyable)
                }
            }
            m.SetItems(res)
        }
...
func (m *ApikeyGetResponse) GetItems()([]i0205054f2bfd71b4890a214c70cc5f227fed51bb9ddda714e68a920d302ce981.ApiKeyable) {
    return m.items
}
...
func (m *ApikeyGetResponse) SetItems(value []i0205054f2bfd71b4890a214c70cc5f227fed51bb9ddda714e68a920d302ce981.ApiKeyable)() {
    m.items = value
}
...
type ApikeyGetResponseable interface {
    ...
    GetItems()([]i0205054f2bfd71b4890a214c70cc5f227fed51bb9ddda714e68a920d302ce981.ApiKeyable)
    GetTotalItems()(*int32)
    SetCurrentPage(value *int32)()
    SetHasMoreItems(value *bool)()
    SetItems(value []i0205054f2bfd71b4890a214c70cc5f227fed51bb9ddda714e68a920d302ce981.ApiKeyable)()
