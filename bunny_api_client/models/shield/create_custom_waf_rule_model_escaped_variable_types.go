...
type CreateCustomWafRuleModel_variableTypes struct {
...
// NewCreateCustomWafRuleModel_variableTypes instantiates a new CreateCustomWafRuleModel_variableTypes and sets the default values.
func NewCreateCustomWafRuleModel_variableTypes()(*CreateCustomWafRuleModel_variableTypes) {
    m := &CreateCustomWafRuleModel_variableTypes{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateCreateCustomWafRuleModel_variableTypesFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateCreateCustomWafRuleModel_variableTypesFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewCreateCustomWafRuleModel_variableTypes(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *CreateCustomWafRuleModel_variableTypes) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetARGS gets the ARGS property value. The ARGS property
// returns a *string when successful
func (m *CreateCustomWafRuleModel_variableTypes) GetARGS()(*string) {
    return m.aRGS
}
// GetARGSCOMBINEDSIZE gets the ARGS_COMBINED_SIZE property value. The ARGS_COMBINED_SIZE property
// returns a *string when successful
func (m *CreateCustomWafRuleModel_variableTypes) GetARGSCOMBINEDSIZE()(*string) {
    return m.aRGS_COMBINED_SIZE
}
// GetARGSGET gets the ARGS_GET property value. The ARGS_GET property
// returns a *string when successful
func (m *CreateCustomWafRuleModel_variableTypes) GetARGSGET()(*string) {
    return m.aRGS_GET
}
// GetARGSGETNAMES gets the ARGS_GET_NAMES property value. The ARGS_GET_NAMES property
// returns a *string when successful
func (m *CreateCustomWafRuleModel_variableTypes) GetARGSGETNAMES()(*string) {
    return m.aRGS_GET_NAMES
}
// GetARGSPOST gets the ARGS_POST property value. The ARGS_POST property
// returns a *string when successful
func (m *CreateCustomWafRuleModel_variableTypes) GetARGSPOST()(*string) {
    return m.aRGS_POST
}
// GetARGSPOSTNAMES gets the ARGS_POST_NAMES property value. The ARGS_POST_NAMES property
// returns a *string when successful
func (m *CreateCustomWafRuleModel_variableTypes) GetARGSPOSTNAMES()(*string) {
    return m.aRGS_POST_NAMES
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *CreateCustomWafRuleModel_variableTypes) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *CreateCustomWafRuleModel_variableTypes) SetREQUESTCOOKIESNAMES(value *string)() {
    m.rEQUEST_COOKIES_NAMES = value
}
// SetREQUESTFILENAME sets the REQUEST_FILENAME property value. The REQUEST_FILENAME property
func (m *CreateCustomWafRuleModel_variableTypes) SetREQUESTFILENAME(value *string)() {
    m.rEQUEST_FILENAME = value
}
// SetREQUESTHEADERS sets the REQUEST_HEADERS property value. The REQUEST_HEADERS property
func (m *CreateCustomWafRuleModel_variableTypes) SetREQUESTHEADERS(value *string)() {
