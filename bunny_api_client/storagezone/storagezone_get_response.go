...
type StoragezoneGetResponse struct {
    ...
    hasMoreItems *bool
    // The Items property
    items []i35697601df5820fe555c46235c796ce9ca5e9d758cc28eaf0fc2ed84d4a3aaa1.StorageZoneable
...
func (m *StoragezoneGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["Items"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i35697601df5820fe555c46235c796ce9ca5e9d758cc28eaf0fc2ed84d4a3aaa1.CreateStorageZoneFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i35697601df5820fe555c46235c796ce9ca5e9d758cc28eaf0fc2ed84d4a3aaa1.StorageZoneable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(i35697601df5820fe555c46235c796ce9ca5e9d758cc28eaf0fc2ed84d4a3aaa1.StorageZoneable)
                }
            }
            m.SetItems(res)
        }
...
type StoragezoneGetResponseable interface {
    ...
    GetItems()([]i35697601df5820fe555c46235c796ce9ca5e9d758cc28eaf0fc2ed84d4a3aaa1.StorageZoneable)
    GetTotalItems()(*int32)
    SetCurrentPage(value *int32)()
    SetHasMoreItems(value *bool)()
    SetItems(value []i35697601df5820fe555c46235c796ce9ca5e9d758cc28eaf0fc2ed84d4a3aaa1.StorageZoneable)()
