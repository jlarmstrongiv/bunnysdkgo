...
func NewItemResolveRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemResolveRequestBuilder) {
    m := &ItemResolveRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/abusecase/{id}/resolve", pathParameters),
    }
    return m
}
...
// Post [ResolveAbuseCase API Docs](https://docs.bunny.net/reference/abusecasepublic_resolveabusecase2)
...
// ToPostRequestInformation [ResolveAbuseCase API Docs](https://docs.bunny.net/reference/abusecasepublic_resolveabusecase2)
