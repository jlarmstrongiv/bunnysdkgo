...
type AbusecaseGetResponse struct {
    ...
    hasMoreItems *bool
    // The Items property
    items []i41e32aef8b8bf7891740cc7b79701dd14df932502bd55cfb248d7543f74f02fc.AbuseCaseable
...
func (m *AbusecaseGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["Items"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i41e32aef8b8bf7891740cc7b79701dd14df932502bd55cfb248d7543f74f02fc.CreateAbuseCaseFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i41e32aef8b8bf7891740cc7b79701dd14df932502bd55cfb248d7543f74f02fc.AbuseCaseable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(i41e32aef8b8bf7891740cc7b79701dd14df932502bd55cfb248d7543f74f02fc.AbuseCaseable)
                }
            }
            m.SetItems(res)
        }
...
func (m *AbusecaseGetResponse) GetItems()([]i41e32aef8b8bf7891740cc7b79701dd14df932502bd55cfb248d7543f74f02fc.AbuseCaseable) {
    return m.items
}
...
func (m *AbusecaseGetResponse) SetItems(value []i41e32aef8b8bf7891740cc7b79701dd14df932502bd55cfb248d7543f74f02fc.AbuseCaseable)() {
    m.items = value
}
...
type AbusecaseGetResponseable interface {
    ...
    GetItems()([]i41e32aef8b8bf7891740cc7b79701dd14df932502bd55cfb248d7543f74f02fc.AbuseCaseable)
    GetTotalItems()(*int32)
    SetCurrentPage(value *int32)()
    SetHasMoreItems(value *bool)()
    SetItems(value []i41e32aef8b8bf7891740cc7b79701dd14df932502bd55cfb248d7543f74f02fc.AbuseCaseable)()
