...
// WithPathSlash builds and executes requests for operations under \{storageZoneName}\{+path}\
// returns a *ItemWithPathSlashRequestBuilder when successful
func (m *WithStorageZoneNameItemRequestBuilder) WithPathSlash(path *string)(*ItemWithPathSlashRequestBuilder) {
    return NewItemWithPathSlashRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, path)
}
