...
type ItemCollectionsGetResponse struct {
    ...
    currentPage *int32
    // The items property
    items []i850d43ce11cdefb3b02ff25c6bb9d6e464cec45fef37ec8775101de5fca8b880.Collectionable
...
func (m *ItemCollectionsGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["items"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i850d43ce11cdefb3b02ff25c6bb9d6e464cec45fef37ec8775101de5fca8b880.CreateCollectionFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i850d43ce11cdefb3b02ff25c6bb9d6e464cec45fef37ec8775101de5fca8b880.Collectionable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(i850d43ce11cdefb3b02ff25c6bb9d6e464cec45fef37ec8775101de5fca8b880.Collectionable)
                }
            }
            m.SetItems(res)
        }
...
func (m *ItemCollectionsGetResponse) GetItems()([]i850d43ce11cdefb3b02ff25c6bb9d6e464cec45fef37ec8775101de5fca8b880.Collectionable) {
    return m.items
}
...
func (m *ItemCollectionsGetResponse) SetItems(value []i850d43ce11cdefb3b02ff25c6bb9d6e464cec45fef37ec8775101de5fca8b880.Collectionable)() {
    m.items = value
}
...
type ItemCollectionsGetResponseable interface {
    ...
    GetItems()([]i850d43ce11cdefb3b02ff25c6bb9d6e464cec45fef37ec8775101de5fca8b880.Collectionable)
    GetItemsPerPage()(*int32)
    GetTotalItems()(*int32)
    SetCurrentPage(value *int32)()
    SetItems(value []i850d43ce11cdefb3b02ff25c6bb9d6e464cec45fef37ec8775101de5fca8b880.Collectionable)()
