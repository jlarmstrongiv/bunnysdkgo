...
type ItemVideosGetResponse struct {
    ...
    currentPage *int32
    // The items property
    items []i5844a9acb9b86d746987515c853816c5c1b43b73d4191fff3bb0559feea76234.Videoable
...
func (m *ItemVideosGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["items"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i5844a9acb9b86d746987515c853816c5c1b43b73d4191fff3bb0559feea76234.CreateVideoFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i5844a9acb9b86d746987515c853816c5c1b43b73d4191fff3bb0559feea76234.Videoable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(i5844a9acb9b86d746987515c853816c5c1b43b73d4191fff3bb0559feea76234.Videoable)
                }
            }
            m.SetItems(res)
        }
...
func (m *ItemVideosGetResponse) GetItems()([]i5844a9acb9b86d746987515c853816c5c1b43b73d4191fff3bb0559feea76234.Videoable) {
    return m.items
}
...
func (m *ItemVideosGetResponse) SetItems(value []i5844a9acb9b86d746987515c853816c5c1b43b73d4191fff3bb0559feea76234.Videoable)() {
    m.items = value
}
...
type ItemVideosGetResponseable interface {
    ...
    GetItems()([]i5844a9acb9b86d746987515c853816c5c1b43b73d4191fff3bb0559feea76234.Videoable)
    GetItemsPerPage()(*int32)
    GetTotalItems()(*int32)
    SetCurrentPage(value *int32)()
    SetItems(value []i5844a9acb9b86d746987515c853816c5c1b43b73d4191fff3bb0559feea76234.Videoable)()
