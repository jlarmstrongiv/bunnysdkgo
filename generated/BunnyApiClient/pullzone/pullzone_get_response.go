...
type PullzoneGetResponse struct {
    ...
    hasMoreItems *bool
    // The Items property
    items []id1f978eb657ca81d9e4d7cee675850f471201dd71ed8d22f02520011358b9428.PullZoneable
...
func (m *PullzoneGetResponse) GetItems()([]id1f978eb657ca81d9e4d7cee675850f471201dd71ed8d22f02520011358b9428.PullZoneable) {
    return m.items
}
...
func (m *PullzoneGetResponse) SetItems(value []id1f978eb657ca81d9e4d7cee675850f471201dd71ed8d22f02520011358b9428.PullZoneable)() {
    m.items = value
}
...
type PullzoneGetResponseable interface {
    ...
    GetItems()([]id1f978eb657ca81d9e4d7cee675850f471201dd71ed8d22f02520011358b9428.PullZoneable)
    GetTotalItems()(*int32)
    SetCurrentPage(value *int32)()
    SetHasMoreItems(value *bool)()
    SetItems(value []id1f978eb657ca81d9e4d7cee675850f471201dd71ed8d22f02520011358b9428.PullZoneable)()
