...
import (
    ...
    i150c7f570d6462e9002a0b2ccc16fd714eb172ee7adacaa50cb949481ff77d55 "github.com/jlarmstrongiv/bunnysdkgo/generated/LoggingApiClient/withmmwithddwithyy"
)

// LoggingApiClient the main entry point of the SDK, exposes the configuration and the fluent API.
type LoggingApiClient struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// NewLoggingApiClient instantiates a new LoggingApiClient and sets the default values.
func NewLoggingApiClient(requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*LoggingApiClient) {
    m := &LoggingApiClient{
    ...
    if m.BaseRequestBuilder.RequestAdapter.GetBaseUrl() == "" {
        m.BaseRequestBuilder.RequestAdapter.SetBaseUrl("https://logging.bunnycdn.com")
    }
...
func (m *LoggingApiClient) WithMmWithDdWithYy(dd *int32, mm *int32, yy *int32)(*i150c7f570d6462e9002a0b2ccc16fd714eb172ee7adacaa50cb949481ff77d55.WithMmWithDdWithYyRequestBuilder) {
    return i150c7f570d6462e9002a0b2ccc16fd714eb172ee7adacaa50cb949481ff77d55.NewWithMmWithDdWithYyRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter, dd, mm, yy)
}
